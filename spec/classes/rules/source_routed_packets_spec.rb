...
describe 'cis_security_hardening::rules::source_routed_packets' do
      ...
      context "on #{os} with enforce = #{enforce} without ipv6" do
        ...
        it {
          ...
          if enforce
            ...
            is_expected.not_to contain_sysctl('net.ipv6.conf.all.accept_source_route')
            is_expected.not_to contain_sysctl('net.ipv6.conf.default.accept_source_route')
          end
        }
      end
