...
* fixed handling grub configuration for UEFI systems as the grub.cfg in the EFI directory was not updated. The grub.cfg in the EFI is only created if there are changes to roll out.
